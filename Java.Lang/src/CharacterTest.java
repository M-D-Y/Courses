class CharacterTest{
  ...
  //System.out.println("ch isldentifierlgnorable? " + Character.isldentifierlgnorable(ch)); 

  System.out.println("ch isISOControl? " + Character.isISOControl(ch)); 

 // System.out.println("ch isJavaldentifierPart? " +  Character.isJavaldentifierPart(ch)); 

 // System.out.println("ch isJavaldentifierStart? " + Character.isJavaldentifierStart(ch)); 
 ...
 // System.out.println("ch isUnicodeldentifierPart? " + Character.isUnicodeldentifierPart(ch)); 

 // System.out.println("ch isUnicodeldentifierStart? " + Character.isUnicodeldentifierStart(ch)); 
